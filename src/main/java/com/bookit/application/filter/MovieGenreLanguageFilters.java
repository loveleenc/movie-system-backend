...
public class MovieGenreLanguageFilters implements Filter {
    ...
    public void doFilter(ServletRequest request,
        ...
        String[] genre = req.getParameterValues("genre"); //TODO: Fix for situations when genre is not provided
        ...
        String[] languages = req.getParameterValues("language");    //TODO: Fix for situations when language is not provided
