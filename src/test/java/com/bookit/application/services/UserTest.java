...
import com.bookit.application.security.user.UserAccountCreationHelper;
...
public class UserTest {
    ...
    public static void beforeAll() {
        ...
        userService = new UserService(customUserDetailsService,
                tokenService, emailService, userAccountCreationHelper, bookingClient);
    }
    ...
    public void test_verifyCreationOfValidUserAsCustomer() {
        ...
        verify(bookingClient, times(1)).createCart(createdUser.getId());
    }
}
