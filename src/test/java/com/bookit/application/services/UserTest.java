...
public class UserTest {
  ...
  private User user;
  //user creation fails
  //username - length is less than 8 and more than 15
  //username - has characters other than uppercase/lowercase and digits


  //password - length is less than 8 and more than 20

  //password -  doesnt contain digits
  //password - doesnt contain uppercase or lowercase characters
  //password - doesnt special characters
  ...
  public static void beforeAll() {
    ...
    cartDao = mock(ICartDao.class);
    userService = new UserService(customUserDetailsService,
      tokenService, emailService, cartDao, userAccountCreationHelper);
  }
  ...
  public void test_verifyCreationOfValidUserAsCustomer() {
    ...
    verify(cartDao, times(1)).createCart(createdUser.getId());
  }
}
