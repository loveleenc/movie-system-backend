...
import com.bookit.booking.db.ISeatDao;
import com.bookit.booking.db.ITicketDao;
...
import com.bookit.booking.user.UserClient;
...
//                            || (currentStatus.equals(TicketStatus.RESERVED) && newStatusEnum.equals(TicketStatus.AVAILABLE))
    ...
    public void createTickets(Long moviePrice, Show show, String status) throws ResourceCreationException {
        ...
        List<Seat> seats = this.getSeatsFromTheatre(show.getTheatre().getId());
        if (seats.isEmpty()) {
