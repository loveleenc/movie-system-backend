...
import com.bookit.booking.dto.inbound.api.ticket.TicketDtoMapper;
...
public class TicketsController {
    ...
    public ResponseEntity<List<TicketDto>> getTicketsForUser(@RequestHeader HttpHeaders httpHeaders,
                                                             HttpServletRequest httpServletRequest){
        for(String key: httpHeaders.keySet()){
            System.out.println(key + ": " + httpHeaders.get(key));
        }
        System.out.println("auth header is: " + httpServletRequest.getHeader("Authorization"));
