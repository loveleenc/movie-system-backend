package com.bookit.theatre.utils;

import com.bookit.theatre.dto.TheatreDto;
import com.bookit.theatre.dto.TheatreRowDto;
import com.bookit.theatre.entity.Seat;
...
public class TheatreUtil {
    ...
    public static List<Seat> createSeats(TheatreDto theatre){
      List<Seat> seats = new ArrayList<>();
      if(!TheatreUtil.rowLettersMatchRequiredCriteria(theatre.getRowDetailsDto())){
        throw new IllegalArgumentException("Row letters provided as input do the match the required criteria.");
      }
      for(TheatreRowDto row: theatre.getRowDetailsDto()){
